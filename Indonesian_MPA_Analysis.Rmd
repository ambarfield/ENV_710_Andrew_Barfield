...
ggplot(settlement_data, aes(x = Household_Marine_Tenure, y = Place_Attachment_Index)) +
  geom_point() +
  geom_smooth(method = "lm", col = "red") +
  labs(x = "Household Marine Tenure",
       y = "Place Attachment Index") +
  ggtitle("Relationship of Place Attachment to Indonesian MPAs against Household Rights over Marine Resources")
```
